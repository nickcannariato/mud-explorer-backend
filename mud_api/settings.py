...
SECURE_BROWSER_XSS_FILTER = not os.environ['DJ_DEBUG']
SECURE_SSL_REDIRECT = not os.environ['DJ_DEBUG']
...
WSGI_APPLICATION = 'mud_api.wsgi.application'
